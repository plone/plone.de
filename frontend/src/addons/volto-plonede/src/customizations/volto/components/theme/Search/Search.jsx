...
const messages = defineMessages({
  ...
  relevance: {
    id: 'Relevance',
    defineMessage: 'Relevance',
  },
  alphabetically: {
    id: 'Alphabetically',
    defineMessage: 'Alphabetically',
  },
  dateNewestFirst: {
...
class Search extends Component {
  ...
  onSortChange = (sort_on, sort_order) => {
    let options = qs.parse(this.props.history.location.search);
    ...
    this.setState({ currentPage: 1, active: sort_on }, () => {
              ...
              <Header>
                <Header.Content className="header-content">
                  <Dropdown
                    inline
                    className="sort-by"
                    text={this.props.intl.formatMessage(messages.sortBy)}
                  >
                    <Dropdown.Menu>
                      <Dropdown.Item
                        onClick={() => {
                          this.onSortChange('relevance');
                        }}
                        text={this.props.intl.formatMessage(messages.relevance)}
                        size="tiny"
                      ...
                      <Dropdown.Item
                        onClick={() => {
                          this.onSortChange('sortable_title');
                        }}
                      ...
                      <Dropdown.Item
                        onClick={() => {
                          this.onSortChange('effective', 'reverse');
                        }}
                        text={this.props.intl.formatMessage(
                          messages.dateNewestFirst,
                        )}
                        size="tiny"
                        className={classNames('button-sort', {
